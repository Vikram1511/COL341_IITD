...
class Neural_a:
    ...
    def back_propagate(self,x,y):
        ...
        for i in range(1,len(self.layers)):
            ...
            if(self.activation_func=='relu'):
                sp = relu_derivative(self.layers[-(i+1)].layer_output_z)
...
#%%
    ...
    if(params[0]=='1'):
        ...
        neural_net = Neural_a(trainx,trainy,10,neural_net_arct,ismulti=True,activation_func='sigmoid')
    ...
    if(params[0]=='2'):
        ...
        weights = [np.vstack((w.get_bias(),w.get_weights())) for w in neural_net.layers]
    outputs = neural_net.forward_propagate(trainx)
